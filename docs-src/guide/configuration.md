...
```bash
ipman hub search scraper --hub-url https://cnb.cool/lutuai/twisker/twisker/iphub/raw/main
```

Or via environment variable:

```bash
export IPMAN_HUB_URL=https://cnb.cool/lutuai/twisker/twisker/iphub/raw/main
