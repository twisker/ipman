...
```bash
ipman hub search scraper --hub-url https://codeup.aliyun.com/twisker/iphub/raw/main
```

Or via environment variable:

```bash
export IPMAN_HUB_URL=https://codeup.aliyun.com/twisker/iphub/raw/main
